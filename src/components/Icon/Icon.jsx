// 共用 icon 元件，使用內建 SVG（feather 風格線稿），避免額外安裝圖示套件
const PATHS = {
  search: (
    <>
  ...
  star: (
    <polygon points="12 2.5 15.09 8.76 22 9.77 17 14.64 18.18 21.52 12 18.22 5.82 21.52 7 14.64 2 9.77 8.91 8.76 12 2.5" />
  ),
  more: (
    <>
